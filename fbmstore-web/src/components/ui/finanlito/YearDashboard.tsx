...
interface YearDashboardProps {
  ...
  colors: any; // Se tiver a tipagem ThemeColors, pode substituir
  terms: any;  // Se tiver a tipagem Terminology, pode substituir
}

// 2. COMPONENTE FUNCIONAL COM DESESTRUTURAÇÃO CORRETA
export const YearDashboard = ({
  ...
  <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
    ...
    {/* CONTROLES DE ANO (ANTERIOR / PRÓXIMO) */}
      ...
      {yearData.map(m => (
        <div key={m.index} onClick={() => onOpenMonth(m.index)}
          ...
          <div style={{ fontSize: '0.85rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            ...
            {/* LINHA DE ATRASADOS COM INDICADOR VISUAL */}
